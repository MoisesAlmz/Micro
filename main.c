...
#define inFalse 1
#define TIME_Ca 60
#define BOTON_ABRIR GPIO_PIN_6
#define BOTON_CERRAR GPIO_PIN_7
#define MOTOR_ABRIR GPIO_PIN_8
#define MOTOR_CERRAR GPIO_PIN_9
#define SENSOR_ABRIR GPIO_PIN_1
#define SENSOR_CERRAR GPIO_PIN_2
